...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNOrderInput2goᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateOrder_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg1, err = ec.unmarshalNOrderInput2goᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrder2ᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Order_items(ctx context.Context, field graphql.CollectedField, obj *model.Order) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNItem2ᚕgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItemᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputOrderInput(ctx context.Context, obj interface{}) (model.OrderInput, error) {
	...
	for k, v := range asMap {
		...
		case "items":
			var err error
			it.Items, err = ec.unmarshalNItemInput2ᚕᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItemInputᚄ(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) marshalNItem2goᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v model.Item) graphql.Marshaler {
	return ec._Item(ctx, sel, &v)
}

func (ec *executionContext) marshalNItem2ᚕgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItemᚄ(ctx context.Context, sel ast.SelectionSet, v []model.Item) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNItem2goᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItem(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalNItemInput2goᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItemInput(ctx context.Context, v interface{}) (model.ItemInput, error) {
	return ec.unmarshalInputItemInput(ctx, v)
}

func (ec *executionContext) unmarshalNItemInput2ᚕᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItemInputᚄ(ctx context.Context, v interface{}) ([]*model.ItemInput, error) {
	...
	for i := range vSlice {
		res[i], err = ec.unmarshalNItemInput2ᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItemInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNItemInput2ᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItemInput(ctx context.Context, v interface{}) (*model.ItemInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalNItemInput2goᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐItemInput(ctx, v)
	return &res, err
}

func (ec *executionContext) marshalNOrder2goᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgoᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNOrderInput2goᚑgqlgenᚑgormᚑmysqlᚑdemoᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v interface{}) (model.OrderInput, error) {
